 ...
 */
@ApiModel(description = "The Windows specific settings applied to all containers. If unspecified, the options from the PodSecurityContext will be used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.")
...
public class V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions {
  ...
  public V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions gmsaCredentialSpec(String gmsaCredentialSpec) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions gmsaCredentialSpecName(String gmsaCredentialSpecName) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions hostProcess(Boolean hostProcess) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions runAsUserName(String runAsUserName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions v1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions = (V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions) o;
    return Objects.equals(this.gmsaCredentialSpec, v1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions.gmsaCredentialSpec) &&
        Objects.equals(this.gmsaCredentialSpecName, v1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions.gmsaCredentialSpecName) &&
        Objects.equals(this.hostProcess, v1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions.hostProcess) &&
        Objects.equals(this.runAsUserName, v1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions.runAsUserName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateSecurityContextWindowsOptions {\n");
