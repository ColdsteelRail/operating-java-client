...
public class V1alpha1PodDecorationSpecTemplateScaleIOSecretRef {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;


  public V1alpha1PodDecorationSpecTemplateScaleIOSecretRef name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateScaleIOSecretRef v1alpha1PodDecorationSpecTemplateScaleIOSecretRef = (V1alpha1PodDecorationSpecTemplateScaleIOSecretRef) o;
    return Objects.equals(this.name, v1alpha1PodDecorationSpecTemplateScaleIOSecretRef.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateScaleIOSecretRef {\n");
