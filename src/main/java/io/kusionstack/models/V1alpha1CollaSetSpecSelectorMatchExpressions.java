...
public class V1alpha1CollaSetSpecSelectorMatchExpressions {
  ...
  public V1alpha1CollaSetSpecSelectorMatchExpressions key(String key) {
  ...
  **/
  ...
  public V1alpha1CollaSetSpecSelectorMatchExpressions operator(String operator) {
  ...
  **/
  ...
  public V1alpha1CollaSetSpecSelectorMatchExpressions values(List<String> values) {
    
    this.values = values;
    return this;
  }

  public V1alpha1CollaSetSpecSelectorMatchExpressions addValuesItem(String valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1CollaSetSpecSelectorMatchExpressions v1alpha1CollaSetSpecSelectorMatchExpressions = (V1alpha1CollaSetSpecSelectorMatchExpressions) o;
    return Objects.equals(this.key, v1alpha1CollaSetSpecSelectorMatchExpressions.key) &&
        Objects.equals(this.operator, v1alpha1CollaSetSpecSelectorMatchExpressions.operator) &&
        Objects.equals(this.values, v1alpha1CollaSetSpecSelectorMatchExpressions.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1CollaSetSpecSelectorMatchExpressions {\n");
