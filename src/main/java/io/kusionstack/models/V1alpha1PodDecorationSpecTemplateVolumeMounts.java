...
public class V1alpha1PodDecorationSpecTemplateVolumeMounts {
  ...
  public V1alpha1PodDecorationSpecTemplateVolumeMounts mountPath(String mountPath) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateVolumeMounts mountPropagation(String mountPropagation) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateVolumeMounts name(String name) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateVolumeMounts readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateVolumeMounts subPath(String subPath) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateVolumeMounts subPathExpr(String subPathExpr) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateVolumeMounts v1alpha1PodDecorationSpecTemplateVolumeMounts = (V1alpha1PodDecorationSpecTemplateVolumeMounts) o;
    return Objects.equals(this.mountPath, v1alpha1PodDecorationSpecTemplateVolumeMounts.mountPath) &&
        Objects.equals(this.mountPropagation, v1alpha1PodDecorationSpecTemplateVolumeMounts.mountPropagation) &&
        Objects.equals(this.name, v1alpha1PodDecorationSpecTemplateVolumeMounts.name) &&
        Objects.equals(this.readOnly, v1alpha1PodDecorationSpecTemplateVolumeMounts.readOnly) &&
        Objects.equals(this.subPath, v1alpha1PodDecorationSpecTemplateVolumeMounts.subPath) &&
        Objects.equals(this.subPathExpr, v1alpha1PodDecorationSpecTemplateVolumeMounts.subPathExpr);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateVolumeMounts {\n");
