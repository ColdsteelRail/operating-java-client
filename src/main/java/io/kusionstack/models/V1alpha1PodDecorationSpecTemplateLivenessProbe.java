...
public class V1alpha1PodDecorationSpecTemplateLivenessProbe {
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe exec(V1alpha1PodDecorationSpecTemplateLifecyclePostStartExec exec) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe failureThreshold(Integer failureThreshold) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe httpGet(V1alpha1PodDecorationSpecTemplateLifecyclePostStartHttpGet httpGet) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe initialDelaySeconds(Integer initialDelaySeconds) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe periodSeconds(Integer periodSeconds) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe successThreshold(Integer successThreshold) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe tcpSocket(V1alpha1PodDecorationSpecTemplateLifecyclePostStartTcpSocket tcpSocket) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe terminationGracePeriodSeconds(Long terminationGracePeriodSeconds) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateLivenessProbe timeoutSeconds(Integer timeoutSeconds) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateLivenessProbe v1alpha1PodDecorationSpecTemplateLivenessProbe = (V1alpha1PodDecorationSpecTemplateLivenessProbe) o;
    return Objects.equals(this.exec, v1alpha1PodDecorationSpecTemplateLivenessProbe.exec) &&
        Objects.equals(this.failureThreshold, v1alpha1PodDecorationSpecTemplateLivenessProbe.failureThreshold) &&
        Objects.equals(this.httpGet, v1alpha1PodDecorationSpecTemplateLivenessProbe.httpGet) &&
        Objects.equals(this.initialDelaySeconds, v1alpha1PodDecorationSpecTemplateLivenessProbe.initialDelaySeconds) &&
        Objects.equals(this.periodSeconds, v1alpha1PodDecorationSpecTemplateLivenessProbe.periodSeconds) &&
        Objects.equals(this.successThreshold, v1alpha1PodDecorationSpecTemplateLivenessProbe.successThreshold) &&
        Objects.equals(this.tcpSocket, v1alpha1PodDecorationSpecTemplateLivenessProbe.tcpSocket) &&
        Objects.equals(this.terminationGracePeriodSeconds, v1alpha1PodDecorationSpecTemplateLivenessProbe.terminationGracePeriodSeconds) &&
        Objects.equals(this.timeoutSeconds, v1alpha1PodDecorationSpecTemplateLivenessProbe.timeoutSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateLivenessProbe {\n");
