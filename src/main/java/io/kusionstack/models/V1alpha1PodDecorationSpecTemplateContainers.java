...
/**
 * V1alpha1PodDecorationSpecTemplateContainers
 */
...
public class V1alpha1PodDecorationSpecTemplateContainers {
  ...
  public static final String SERIALIZED_NAME_INJECT_POLICY = "injectPolicy";
  @SerializedName(SERIALIZED_NAME_INJECT_POLICY)
  private String injectPolicy;
  ...
  public V1alpha1PodDecorationSpecTemplateContainers args(List<String> args) {
    
    this.args = args;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateContainers addArgsItem(String argsItem) {
    if (this.args == null) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers command(List<String> command) {
    
    this.command = command;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateContainers addCommandItem(String commandItem) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers env(List<V1alpha1PodDecorationSpecTemplateEnv> env) {
    
    this.env = env;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateContainers addEnvItem(V1alpha1PodDecorationSpecTemplateEnv envItem) {
    if (this.env == null) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers envFrom(List<V1alpha1PodDecorationSpecTemplateEnvFrom> envFrom) {
    
    this.envFrom = envFrom;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateContainers addEnvFromItem(V1alpha1PodDecorationSpecTemplateEnvFrom envFromItem) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers image(String image) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers imagePullPolicy(String imagePullPolicy) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers injectPolicy(String injectPolicy) {
    
    this.injectPolicy = injectPolicy;
    return this;
  }

   /**
   * InjectPolicy indicates the position to inject the Container configuration. Default is BeforePrimaryContainer.
   * @return injectPolicy
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "InjectPolicy indicates the position to inject the Container configuration. Default is BeforePrimaryContainer.")

  public String getInjectPolicy() {
    return injectPolicy;
  }


  public void setInjectPolicy(String injectPolicy) {
    this.injectPolicy = injectPolicy;
  }


  public V1alpha1PodDecorationSpecTemplateContainers lifecycle(V1alpha1PodDecorationSpecTemplateLifecycle lifecycle) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers livenessProbe(V1alpha1PodDecorationSpecTemplateLivenessProbe livenessProbe) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers name(String name) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers ports(List<V1alpha1PodDecorationSpecTemplatePorts> ports) {
    
    this.ports = ports;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateContainers addPortsItem(V1alpha1PodDecorationSpecTemplatePorts portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers readinessProbe(V1alpha1PodDecorationSpecTemplateReadinessProbe readinessProbe) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers resources(V1alpha1PodDecorationSpecTemplateResources resources) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers securityContext(V1alpha1PodDecorationSpecTemplateSecurityContext securityContext) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers startupProbe(V1alpha1PodDecorationSpecTemplateStartupProbe startupProbe) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers stdin(Boolean stdin) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers stdinOnce(Boolean stdinOnce) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers terminationMessagePath(String terminationMessagePath) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers terminationMessagePolicy(String terminationMessagePolicy) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers tty(Boolean tty) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers volumeDevices(List<V1alpha1PodDecorationSpecTemplateVolumeDevices> volumeDevices) {
    
    this.volumeDevices = volumeDevices;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateContainers addVolumeDevicesItem(V1alpha1PodDecorationSpecTemplateVolumeDevices volumeDevicesItem) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers volumeMounts(List<V1alpha1PodDecorationSpecTemplateVolumeMounts> volumeMounts) {
    
    this.volumeMounts = volumeMounts;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateContainers addVolumeMountsItem(V1alpha1PodDecorationSpecTemplateVolumeMounts volumeMountsItem) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateContainers workingDir(String workingDir) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateContainers v1alpha1PodDecorationSpecTemplateContainers = (V1alpha1PodDecorationSpecTemplateContainers) o;
    return Objects.equals(this.args, v1alpha1PodDecorationSpecTemplateContainers.args) &&
        Objects.equals(this.command, v1alpha1PodDecorationSpecTemplateContainers.command) &&
        Objects.equals(this.env, v1alpha1PodDecorationSpecTemplateContainers.env) &&
        Objects.equals(this.envFrom, v1alpha1PodDecorationSpecTemplateContainers.envFrom) &&
        Objects.equals(this.image, v1alpha1PodDecorationSpecTemplateContainers.image) &&
        Objects.equals(this.imagePullPolicy, v1alpha1PodDecorationSpecTemplateContainers.imagePullPolicy) &&
        Objects.equals(this.injectPolicy, v1alpha1PodDecorationSpecTemplateContainers.injectPolicy) &&
        Objects.equals(this.lifecycle, v1alpha1PodDecorationSpecTemplateContainers.lifecycle) &&
        Objects.equals(this.livenessProbe, v1alpha1PodDecorationSpecTemplateContainers.livenessProbe) &&
        Objects.equals(this.name, v1alpha1PodDecorationSpecTemplateContainers.name) &&
        Objects.equals(this.ports, v1alpha1PodDecorationSpecTemplateContainers.ports) &&
        Objects.equals(this.readinessProbe, v1alpha1PodDecorationSpecTemplateContainers.readinessProbe) &&
        Objects.equals(this.resources, v1alpha1PodDecorationSpecTemplateContainers.resources) &&
        Objects.equals(this.securityContext, v1alpha1PodDecorationSpecTemplateContainers.securityContext) &&
        Objects.equals(this.startupProbe, v1alpha1PodDecorationSpecTemplateContainers.startupProbe) &&
        Objects.equals(this.stdin, v1alpha1PodDecorationSpecTemplateContainers.stdin) &&
        Objects.equals(this.stdinOnce, v1alpha1PodDecorationSpecTemplateContainers.stdinOnce) &&
        Objects.equals(this.terminationMessagePath, v1alpha1PodDecorationSpecTemplateContainers.terminationMessagePath) &&
        Objects.equals(this.terminationMessagePolicy, v1alpha1PodDecorationSpecTemplateContainers.terminationMessagePolicy) &&
        Objects.equals(this.tty, v1alpha1PodDecorationSpecTemplateContainers.tty) &&
        Objects.equals(this.volumeDevices, v1alpha1PodDecorationSpecTemplateContainers.volumeDevices) &&
        Objects.equals(this.volumeMounts, v1alpha1PodDecorationSpecTemplateContainers.volumeMounts) &&
        Objects.equals(this.workingDir, v1alpha1PodDecorationSpecTemplateContainers.workingDir);
  }

  @Override
  public int hashCode() {
    return Objects.hash(args, command, env, envFrom, image, imagePullPolicy, injectPolicy, lifecycle, livenessProbe, name, ports, readinessProbe, resources, securityContext, startupProbe, stdin, stdinOnce, terminationMessagePath, terminationMessagePolicy, tty, volumeDevices, volumeMounts, workingDir);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateContainers {\n");
    ...
    sb.append("    injectPolicy: ").append(toIndentedString(injectPolicy)).append("\n");
