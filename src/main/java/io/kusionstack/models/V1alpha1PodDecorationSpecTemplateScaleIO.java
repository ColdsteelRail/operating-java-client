...
import io.kusionstack.models.V1alpha1PodDecorationSpecTemplateScaleIOSecretRef;
...
public class V1alpha1PodDecorationSpecTemplateScaleIO {
  ...
  private V1alpha1PodDecorationSpecTemplateScaleIOSecretRef secretRef;
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO fsType(String fsType) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO gateway(String gateway) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO protectionDomain(String protectionDomain) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO secretRef(V1alpha1PodDecorationSpecTemplateScaleIOSecretRef secretRef) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIOSecretRef getSecretRef() {
    return secretRef;
  }


  public void setSecretRef(V1alpha1PodDecorationSpecTemplateScaleIOSecretRef secretRef) {
    this.secretRef = secretRef;
  }


  public V1alpha1PodDecorationSpecTemplateScaleIO sslEnabled(Boolean sslEnabled) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO storageMode(String storageMode) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO storagePool(String storagePool) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO system(String system) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateScaleIO volumeName(String volumeName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateScaleIO v1alpha1PodDecorationSpecTemplateScaleIO = (V1alpha1PodDecorationSpecTemplateScaleIO) o;
    return Objects.equals(this.fsType, v1alpha1PodDecorationSpecTemplateScaleIO.fsType) &&
        Objects.equals(this.gateway, v1alpha1PodDecorationSpecTemplateScaleIO.gateway) &&
        Objects.equals(this.protectionDomain, v1alpha1PodDecorationSpecTemplateScaleIO.protectionDomain) &&
        Objects.equals(this.readOnly, v1alpha1PodDecorationSpecTemplateScaleIO.readOnly) &&
        Objects.equals(this.secretRef, v1alpha1PodDecorationSpecTemplateScaleIO.secretRef) &&
        Objects.equals(this.sslEnabled, v1alpha1PodDecorationSpecTemplateScaleIO.sslEnabled) &&
        Objects.equals(this.storageMode, v1alpha1PodDecorationSpecTemplateScaleIO.storageMode) &&
        Objects.equals(this.storagePool, v1alpha1PodDecorationSpecTemplateScaleIO.storagePool) &&
        Objects.equals(this.system, v1alpha1PodDecorationSpecTemplateScaleIO.system) &&
        Objects.equals(this.volumeName, v1alpha1PodDecorationSpecTemplateScaleIO.volumeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateScaleIO {\n");
