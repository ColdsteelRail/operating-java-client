...
public class V1alpha1PodDecorationSpecTemplateTolerations {
  ...
  public V1alpha1PodDecorationSpecTemplateTolerations effect(String effect) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateTolerations key(String key) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateTolerations operator(String operator) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateTolerations tolerationSeconds(Long tolerationSeconds) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateTolerations value(String value) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateTolerations v1alpha1PodDecorationSpecTemplateTolerations = (V1alpha1PodDecorationSpecTemplateTolerations) o;
    return Objects.equals(this.effect, v1alpha1PodDecorationSpecTemplateTolerations.effect) &&
        Objects.equals(this.key, v1alpha1PodDecorationSpecTemplateTolerations.key) &&
        Objects.equals(this.operator, v1alpha1PodDecorationSpecTemplateTolerations.operator) &&
        Objects.equals(this.tolerationSeconds, v1alpha1PodDecorationSpecTemplateTolerations.tolerationSeconds) &&
        Objects.equals(this.value, v1alpha1PodDecorationSpecTemplateTolerations.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateTolerations {\n");
