...
public class V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms {
  ...
  public V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms matchExpressions(List<V1alpha1PodDecorationSpecTemplateAffinityMatchExpressions> matchExpressions) {
    
    this.matchExpressions = matchExpressions;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms addMatchExpressionsItem(V1alpha1PodDecorationSpecTemplateAffinityMatchExpressions matchExpressionsItem) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms matchFields(List<V1alpha1PodDecorationSpecTemplateAffinityMatchExpressions> matchFields) {
    
    this.matchFields = matchFields;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms addMatchFieldsItem(V1alpha1PodDecorationSpecTemplateAffinityMatchExpressions matchFieldsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms v1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms = (V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms) o;
    return Objects.equals(this.matchExpressions, v1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms.matchExpressions) &&
        Objects.equals(this.matchFields, v1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms.matchFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateAffinityNodeSelectorTerms {\n");
