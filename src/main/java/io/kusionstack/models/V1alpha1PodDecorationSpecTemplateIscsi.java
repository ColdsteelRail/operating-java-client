...
import io.kusionstack.models.V1alpha1PodDecorationSpecTemplateIscsiSecretRef;
...
public class V1alpha1PodDecorationSpecTemplateIscsi {
  ...
  private V1alpha1PodDecorationSpecTemplateIscsiSecretRef secretRef;
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi chapAuthDiscovery(Boolean chapAuthDiscovery) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi chapAuthSession(Boolean chapAuthSession) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi fsType(String fsType) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi initiatorName(String initiatorName) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi iqn(String iqn) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi iscsiInterface(String iscsiInterface) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi lun(Integer lun) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi portals(List<String> portals) {
    
    this.portals = portals;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateIscsi addPortalsItem(String portalsItem) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsi secretRef(V1alpha1PodDecorationSpecTemplateIscsiSecretRef secretRef) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateIscsiSecretRef getSecretRef() {
    return secretRef;
  }


  public void setSecretRef(V1alpha1PodDecorationSpecTemplateIscsiSecretRef secretRef) {
    this.secretRef = secretRef;
  }


  public V1alpha1PodDecorationSpecTemplateIscsi targetPortal(String targetPortal) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateIscsi v1alpha1PodDecorationSpecTemplateIscsi = (V1alpha1PodDecorationSpecTemplateIscsi) o;
    return Objects.equals(this.chapAuthDiscovery, v1alpha1PodDecorationSpecTemplateIscsi.chapAuthDiscovery) &&
        Objects.equals(this.chapAuthSession, v1alpha1PodDecorationSpecTemplateIscsi.chapAuthSession) &&
        Objects.equals(this.fsType, v1alpha1PodDecorationSpecTemplateIscsi.fsType) &&
        Objects.equals(this.initiatorName, v1alpha1PodDecorationSpecTemplateIscsi.initiatorName) &&
        Objects.equals(this.iqn, v1alpha1PodDecorationSpecTemplateIscsi.iqn) &&
        Objects.equals(this.iscsiInterface, v1alpha1PodDecorationSpecTemplateIscsi.iscsiInterface) &&
        Objects.equals(this.lun, v1alpha1PodDecorationSpecTemplateIscsi.lun) &&
        Objects.equals(this.portals, v1alpha1PodDecorationSpecTemplateIscsi.portals) &&
        Objects.equals(this.readOnly, v1alpha1PodDecorationSpecTemplateIscsi.readOnly) &&
        Objects.equals(this.secretRef, v1alpha1PodDecorationSpecTemplateIscsi.secretRef) &&
        Objects.equals(this.targetPortal, v1alpha1PodDecorationSpecTemplateIscsi.targetPortal);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateIscsi {\n");
