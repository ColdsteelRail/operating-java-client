...
public class V1alpha1PodDecorationSpecTemplateSecret {
  ...
  public V1alpha1PodDecorationSpecTemplateSecret defaultMode(Integer defaultMode) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateSecret items(List<V1alpha1PodDecorationSpecTemplateConfigMapItems> items) {
    
    this.items = items;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateSecret addItemsItem(V1alpha1PodDecorationSpecTemplateConfigMapItems itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateSecret optional(Boolean optional) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateSecret secretName(String secretName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateSecret v1alpha1PodDecorationSpecTemplateSecret = (V1alpha1PodDecorationSpecTemplateSecret) o;
    return Objects.equals(this.defaultMode, v1alpha1PodDecorationSpecTemplateSecret.defaultMode) &&
        Objects.equals(this.items, v1alpha1PodDecorationSpecTemplateSecret.items) &&
        Objects.equals(this.optional, v1alpha1PodDecorationSpecTemplateSecret.optional) &&
        Objects.equals(this.secretName, v1alpha1PodDecorationSpecTemplateSecret.secretName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateSecret {\n");
