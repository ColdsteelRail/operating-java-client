...
import io.kusionstack.models.V1alpha1PodDecorationSpecTemplateCsiNodePublishSecretRef;
...
public class V1alpha1PodDecorationSpecTemplateCsi {
  ...
  private V1alpha1PodDecorationSpecTemplateCsiNodePublishSecretRef nodePublishSecretRef;
  ...
  public V1alpha1PodDecorationSpecTemplateCsi driver(String driver) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateCsi fsType(String fsType) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateCsi nodePublishSecretRef(V1alpha1PodDecorationSpecTemplateCsiNodePublishSecretRef nodePublishSecretRef) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateCsiNodePublishSecretRef getNodePublishSecretRef() {
    return nodePublishSecretRef;
  }


  public void setNodePublishSecretRef(V1alpha1PodDecorationSpecTemplateCsiNodePublishSecretRef nodePublishSecretRef) {
    this.nodePublishSecretRef = nodePublishSecretRef;
  }


  public V1alpha1PodDecorationSpecTemplateCsi readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateCsi volumeAttributes(Map<String, String> volumeAttributes) {
    
    this.volumeAttributes = volumeAttributes;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateCsi putVolumeAttributesItem(String key, String volumeAttributesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateCsi v1alpha1PodDecorationSpecTemplateCsi = (V1alpha1PodDecorationSpecTemplateCsi) o;
    return Objects.equals(this.driver, v1alpha1PodDecorationSpecTemplateCsi.driver) &&
        Objects.equals(this.fsType, v1alpha1PodDecorationSpecTemplateCsi.fsType) &&
        Objects.equals(this.nodePublishSecretRef, v1alpha1PodDecorationSpecTemplateCsi.nodePublishSecretRef) &&
        Objects.equals(this.readOnly, v1alpha1PodDecorationSpecTemplateCsi.readOnly) &&
        Objects.equals(this.volumeAttributes, v1alpha1PodDecorationSpecTemplateCsi.volumeAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateCsi {\n");
