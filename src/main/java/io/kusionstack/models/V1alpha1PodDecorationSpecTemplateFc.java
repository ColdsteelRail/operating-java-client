...
public class V1alpha1PodDecorationSpecTemplateFc {
  ...
  public V1alpha1PodDecorationSpecTemplateFc fsType(String fsType) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateFc lun(Integer lun) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateFc readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateFc targetWWNs(List<String> targetWWNs) {
    
    this.targetWWNs = targetWWNs;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateFc addTargetWWNsItem(String targetWWNsItem) {
  ...
  **/
  ...
  public V1alpha1PodDecorationSpecTemplateFc wwids(List<String> wwids) {
    
    this.wwids = wwids;
    return this;
  }

  public V1alpha1PodDecorationSpecTemplateFc addWwidsItem(String wwidsItem) {
    if (this.wwids == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1PodDecorationSpecTemplateFc v1alpha1PodDecorationSpecTemplateFc = (V1alpha1PodDecorationSpecTemplateFc) o;
    return Objects.equals(this.fsType, v1alpha1PodDecorationSpecTemplateFc.fsType) &&
        Objects.equals(this.lun, v1alpha1PodDecorationSpecTemplateFc.lun) &&
        Objects.equals(this.readOnly, v1alpha1PodDecorationSpecTemplateFc.readOnly) &&
        Objects.equals(this.targetWWNs, v1alpha1PodDecorationSpecTemplateFc.targetWWNs) &&
        Objects.equals(this.wwids, v1alpha1PodDecorationSpecTemplateFc.wwids);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDecorationSpecTemplateFc {\n");
